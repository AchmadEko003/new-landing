...
// Fetch data
const { data, pending, error } = await useLazyFetch<IResponse<IAboutUs>>(
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else-if="data?.data">
      ...
      <section
        ...
        style="
                    background-image: url(&quot;http://103.189.234.243/img-asset/assets/7e2b465e-54d9-418c-a88d-62352fee79c8.jpeg&quot;);
                "
      >
        <!-- Background with gradient overlay -->
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/50 via-black/[1%] to-transparent"
        />
      ...
      <section class="py-16 px-4 md:px-8">
        <div class="max-w-4xl mx-auto">
          <!-- Content Card -->
          <div
            class="bg-white rounded-2xl border border-gray-200 hover:border-primary overflow-hidden"
          >
            <!-- Content Body -->
            ...
            <!-- Action Footer -->
            <div
              class="bg-gray-50 px-8 md:px-12 py-3 border-t border-gray-300"
            >
              <div
                class="flex flex-col sm:flex-row gap-4 justify-end items-center"
              >
                <UButton
                  to="/info"
                  variant="outline"
          ...
          <div class="mt-12 grid md:grid-cols-3 gap-6">
            <div
              class="bg-white rounded-xl p-6 border border-gray-200 hover:border-primary transition-colors"
            >
