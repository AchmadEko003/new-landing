import { e as _export_sfc, g as __nuxt_component_1$2, c as __nuxt_component_2$1, U as __nuxt_component_3, b as _sfc_main$9, u as useRuntimeConfig, i as useAppConfig, s as reactivePick, t as tv, Q as isArrayOfArray, m as _sfc_main$c, _ as _sfc_main$f, N as get, o as _sfc_main$2$1, R as _sfc_main$a, S as pickLinkProps, T as _sfc_main$b, O as usePortal, P as createSharedComposable } from './server.mjs';
import { defineComponent, ref, withAsyncContext, computed, mergeProps, withCtx, createVNode, unref, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, useSlots, toRef, resolveDynamicComponent, renderSlot, withModifiers, toHandlers, reactive, useSSRContext } from 'vue';
...
import { useForwardPropsEmits, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, Primitive } from 'reka-ui';
import { p as publicAssetsURL, j as defu } from '../nitro/nitro.mjs';
import { c as createReusableTemplate } from './index-B3YyvcOz.mjs';
import { HoverCard, Popover } from 'reka-ui/namespaced';
import { _ as _sfc_main$7 } from './Accordion-D-iHN-ul.mjs';
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          item.badge || item.badge === 0 ? (openBlock(), createBlock(_sfc_main$2$1, mergeProps({
                            key: 0,
                            color: "neutral",
                            variant: "outline",
                            size: item.ui?.linkTrailingBadgeSize || props.ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
...
const _imports_0 = publicAssetsURL("/assets/logo-with-title.png");
publicAssetsURL("/assets/logo-with-title-white.png");
const getListCountry = async () => {
  ...
  loading = false;
  return { data: res, pending: loading };
};
const reformattedTodos = (payload) => {
  const tempValue = payload ?? [];
  const result = [];
  tempValue.splice(0, 9).forEach((element) => {
    result.push({
      label: element.name,
      to: `/destinasi-populer/${element.name}_${element.uid}`
      // Adjusted to match the new route structure
    });
  });
  return result;
};
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    ref(false);
    const { data, pending } = ([__temp, __restore] = withAsyncContext(() => getListCountry()), __temp = await __temp, __restore(), __temp);
    computed(() => {
      return [
        {
          label: "Home",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "flex items-center justify-between px-3 md:px-10 h-[62px] shadow-lg sticky top-0 bg-white z-50" }, _attrs))}><div>`);
      _push(ssrRenderComponent(_component_NuxtLink, { href: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Peponi Logo" class="h-12 w-auto"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(ssrRenderComponent(_component_UNavigationMenu, {
        items: unref(itemsDesktop),
        arrow: "",
        class: "item-center justify-end"
      }, null, _parent));
      _push(`</div><div class="block md:hidden">`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="bg-white text-black flex items-center active:scale-95 transition-transform"${_scopeId}>`);
            ...
            return [
              createVNode("button", { class: "bg-white text-black flex items-center active:scale-95 transition-transform" }, [
...
const __nuxt_component_0 = Object.assign(_sfc_main$2, { __name: "NavigationMenu" });
const getDataFooter = async () => {
  ...
  return { aboutUs, termsCondition: terms, loadingFetch: loading };
};
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { aboutUs, termsCondition, loadingFetch } = ([__temp, __restore] = withAsyncContext(() => getDataFooter()), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-gray-50 w-full pt-8 pb-6 px-4 md:px-12 lg:px-24 xl:px-32 2xl:px-44 mt-10" }, _attrs))}><div class="max-w-7xl mx-auto"><div class="md:hidden">`);
      _push(ssrRenderComponent(_component_UAccordion, {
        ...
        "tentang-kami": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-2"${_scopeId}>`);
            if (unref(loadingFetch)) {
              _push2(`<div class="space-y-2"${_scopeId}><div class="h-4 bg-gray-300 rounded animate-pulse w-24"${_scopeId}></div><div class="h-4 bg-gray-300 rounded animate-pulse w-20"${_scopeId}></div></div>`);
            } else if (unref(aboutUs).length > 0) {
              _push2(`<div class="space-y-2"${_scopeId}><!--[-->`);
              ssrRenderList(unref(aboutUs), (item) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(item.header)}`);
                    } else {
                      return [
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Mengenal Peponi `);
                  } else {
                    return [
                      createTextVNode(" Mengenal Peponi ")
                    ];
                  }
                }),
                _: 1
            ...
            return [
              createVNode("div", { class: "space-y-2" }, [
                unref(loadingFetch) ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "space-y-2"
                }, [
                  createVNode("div", { class: "h-4 bg-gray-300 rounded animate-pulse w-24" }),
                  createVNode("div", { class: "h-4 bg-gray-300 rounded animate-pulse w-20" })
                ])) : unref(aboutUs).length > 0 ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "space-y-2"
                }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(aboutUs), (item) => {
        ...
        destinasi: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) ;
          else {
            return [];
          }
        }),
        bantuan: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: "/contact-us",
        ...
        terms: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-2"${_scopeId}>`);
            if (unref(loadingFetch)) {
              _push2(`<div class="space-y-2"${_scopeId}><div class="h-4 bg-gray-300 rounded animate-pulse w-24"${_scopeId}></div><div class="h-4 bg-gray-300 rounded animate-pulse w-20"${_scopeId}></div></div>`);
            } else if (unref(termsCondition).length > 0) {
              _push2(`<div class="space-y-2"${_scopeId}><!--[-->`);
              ssrRenderList(unref(termsCondition), (item, i) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  key: i,
            ...
            return [
              createVNode("div", { class: "space-y-2" }, [
                unref(loadingFetch) ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "h-4 bg-gray-300 rounded animate-pulse w-24" }),
                  createVNode("div", { class: "h-4 bg-gray-300 rounded animate-pulse w-20" })
                ])) : unref(termsCondition).length > 0 ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "space-y-2"
                }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(termsCondition), (item, i) => {
                    return openBlock(), createBlock(_component_NuxtLink, {
                      key: i,
                      to: `/terms-and-conditions/${item.section}`,
                      class: "block text-gray-600 hover:text-primary transition-colors"
      ...
      _push(`</div><div class="hidden md:flex md:flex-wrap md:justify-between md:items-start gap-8"><div class="min-w-[180px]"><div class="font-semibold mb-4 text-gray-900"> Tentang kami </div>`);
      if (unref(loadingFetch)) {
        _push(`<ul class="space-y-3"><li class="animate-pulse"><div class="h-4 bg-gray-300 rounded w-20"></div></li><li class="animate-pulse"><div class="h-4 bg-gray-300 rounded w-16"></div></li></ul>`);
      } else if (unref(aboutUs)) {
        ...
        ssrRenderList(unref(aboutUs), (item) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(item.header)}`);
              } else {
                return [
                  createTextVNode(toDisplayString(item.header), 1)
                ];
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Peponi Frequent Travelers `);
            } else {
              return [
                createTextVNode(" Peponi Frequent Travelers ")
              ];
            }
          }),
          _: 1
      ...
      _push(`</div><div class="min-w-[180px]"><div class="font-semibold mb-4 text-gray-900"> Destinasi </div><ul class="space-y-3"><!--[-->`);
      ssrRenderList(unref(countryStore).countryList, (country) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(country.name ?? "")}`);
            } else {
              return [
      ...
      _push(`<!--]--></ul></div><div class="min-w-[180px]"><div class="font-semibold mb-4 text-gray-900"> Bantuan </div><ul class="space-y-3"><li>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/contact-us",
        class: "text-gray-600 hover:text-primary transition-colors"
      }, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(" Trip Saya ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul></div><div class="min-w-[180px]"><div class="font-semibold mb-4 text-gray-900"> Terms &amp; Conditions </div>`);
      if (unref(loadingFetch)) {
        _push(`<ul class="space-y-3"><li class="animate-pulse"><div class="h-4 bg-gray-300 rounded w-24"></div></li><li class="animate-pulse"><div class="h-4 bg-gray-300 rounded w-20"></div></li></ul>`);
      } else if (unref(termsCondition)) {
        _push(`<ul class="space-y-3"><!--[-->`);
        ssrRenderList(unref(termsCondition), (item, i) => {
          _push(`<li>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</div></div><div class="mt-8 pt-6 border-t border-gray-200"><div class="flex flex-col md:flex-row justify-between items-center gap-4"><div class="flex flex-col gap-4 md:gap-6"><div class="text-lg text-center md:text-start font-medium text-gray-700"> Ikuti kami </div><div class="flex justify-center md:justify-start space-x-3">`);
      ...
      _push(`</div></div></div><div class="mt-6 text-center md:text-left"><div class="text-sm text-gray-600"> © 2024 | Peponi, PT Aku Bisa Liburan </div></div></div></div></footer>`);
    };
  }
});
...
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "NavigationFooter" });
const _sfc_main = {};
...
//# sourceMappingURL=default-Cq_07lVg.mjs.map
