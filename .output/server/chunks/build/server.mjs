import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, nextTick, watch, getCurrentInstance, getCurrentScope, hasInjectionContext, inject, onScopeDispose, computed, mergeProps, unref, withCtx, renderSlot, createBlock, openBlock, h, createVNode, resolveDynamicComponent, useSlots, ref, createCommentVNode, toDisplayString, shallowRef, provide, cloneVNode, createElementBlock, resolveComponent, toValue, toRef as toRef$1, onServerPrefetch, isRef, useAttrs, useTemplateRef, mergeModels, useModel, createTextVNode, reactive, defineAsyncComponent, toRefs, useSSRContext, shallowReactive, Suspense, Fragment, createApp, readonly, customRef, renderList, useId, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, markRaw } from 'vue';
import { s as serialize, j as defu, k as parseQuery, l as klona, m as defuFn, n as isEqual, o as hasProtocol, q as joinURL, w as withQuery, r as withTrailingSlash, t as withoutTrailingSlash, v as isScriptProtocol, x as getContext, y as sanitizeStatusCode, e as createError$1, z as withLeadingSlash, A as parseURL, $ as $fetch$1, B as baseURL, C as createHooks, D as executeAsync, E as toRouteMatcher, F as createRouter$1, G as encodeParam, H as encodePath } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-CLA32h3f.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BIjrfE-F.mjs')
  },
  {
    name: "contact-us",
    path: "/contact-us",
    component: () => import('./contact-us-Bi6mwY0c.mjs')
  },
  {
    name: "info",
    path: "/info",
    component: () => import('./index-BcryvgJJ.mjs')
  },
  {
    name: "trip",
    path: "/trip",
    component: () => import('./index-BDOJ0yC0.mjs')
  },
  {
    name: "book-detail",
    path: "/book/detail",
    component: () => import('./detail-DgEZm1r9.mjs')
  },
  {
    name: "info-slug",
    path: "/info/:slug()",
    component: () => import('./_slug_-Zz_S-W78.mjs')
  },
  {
    name: "info-about-us",
    path: "/info/about-us",
    component: () => import('./about-us-C44XXe9A.mjs')
  },
  {
    name: "trip-tripId",
    path: "/trip/:tripId()",
    component: () => import('./_tripId_-BwzssrH3.mjs')
  },
  {
    name: "pengalaman-unik-uid",
    path: "/pengalaman-unik/:uid()",
    component: () => import('./_uid_-DwdNRcSQ.mjs')
  },
  {
    name: "pengalaman-unik",
    path: "/pengalaman-unik",
    component: () => import('./index-B_IGyQQq.mjs')
  },
  {
    name: "tempat-favorite-uid",
    path: "/tempat-favorite/:uid()",
    component: () => import('./_uid_-Cfp1cvYT.mjs')
  },
  {
    name: "tempat-favorite",
    path: "/tempat-favorite",
    component: () => import('./index-q_iiG9Vt.mjs')
  },
  {
    name: "destinasi-populer-uid",
    path: "/destinasi-populer/:uid()",
    component: () => import('./_uid_-C50Jsbt2.mjs')
  },
  {
    name: "destinasi-populer",
    path: "/destinasi-populer",
    component: () => import('./index-DsczPGw4.mjs')
  },
  {
    name: "terms-and-conditions",
    path: "/terms-and-conditions",
    component: () => import('./index-B1cSh2_A.mjs')
  },
  {
    name: "terms-and-conditions-slug",
    path: "/terms-and-conditions/:slug()",
    component: () => import('./_slug_-xAe9TGCq.mjs')
  }
];
...
const peponiRuntime$GMji_45Sb7WOG66SF87TxvL7E6HPkRMgXVYxoKJxcZ34o = defineProvider({
  getImage(src, { modifiers, baseURL: baseURL2 }) {
    if (!baseURL2) {
      baseURL2 = (/* @__PURE__ */ useRuntimeConfig()).public.siteUrl;
    }
...
const ipxRuntime$_4HTrWuX9QTer648SThPKIcfNHeiVrnFjp0mav48ALN4 = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["peponi"]: { setup: peponiRuntime$GMji_45Sb7WOG66SF87TxvL7E6HPkRMgXVYxoKJxcZ34o, defaults: { "baseURL": "http://103.189.234.243/img-asset" } },
    ["ipx"]: { setup: ipxRuntime$_4HTrWuX9QTer648SThPKIcfNHeiVrnFjp0mav48ALN4, defaults: {} }
  }
};
...
const __nuxt_component_1$1 = Object.assign(_sfc_main$e, { __name: "NuxtImg" });
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Cq_07lVg.mjs').then((m) => m.default || m))
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, mergeProps({ toaster: { position: "top-right" } }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-default" data-vaul-drawer-wrapper${_scopeId}>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4 sm:px-6 lg:px-8" data-v-44b8cb6f${_scopeId}><div class="max-w-2xl w-full text-center" data-v-44b8cb6f${_scopeId}><div class="relative mb-8" data-v-44b8cb6f${_scopeId}><div class="flex justify-center mb-6" data-v-44b8cb6f${_scopeId}><div class="relative" data-v-44b8cb6f${_scopeId}><div class="absolute inset-0 bg-primary/20 rounded-full blur-2xl animate-pulse" data-v-44b8cb6f${_scopeId}></div>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: unref(errorIcon),
              class: "relative w-24 h-24 sm:w-32 sm:h-32 text-primary"
            }, null, _parent2, _scopeId));
            _push2(`</div></div><div class="flex justify-center" data-v-44b8cb6f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UBadge, {
              label: `Error ${__props.error.status}`,
              color: "gray",
              variant: "subtle",
              size: "lg",
              class: "font-mono text-lg px-4 py-2"
            }, null, _parent2, _scopeId));
            _push2(`</div></div><div class="space-y-4 mb-10" data-v-44b8cb6f${_scopeId}><h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900" data-v-44b8cb6f${_scopeId}>${ssrInterpolate(unref(errorTitle))}</h1><p class="text-lg sm:text-xl text-gray-600 max-w-xl mx-auto" data-v-44b8cb6f${_scopeId}>${ssrInterpolate(unref(errorDescription))}</p></div><div class="flex flex-col sm:flex-row items-center justify-center gap-4" data-v-44b8cb6f${_scopeId}>`);
            ...
            _push2(`</div><div class="mt-12 pt-8 border-t border-gray-200" data-v-44b8cb6f${_scopeId}><p class="text-sm text-gray-500" data-v-44b8cb6f${_scopeId}> Need assistance? `);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Contact our support team `);
                } else {
                  return [
                    createTextVNode(" Contact our support team ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</p></div><div class="mt-8 flex justify-center gap-4 text-gray-300" data-v-44b8cb6f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
            ...
            return [
              createVNode("div", { class: "min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4 sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "max-w-2xl w-full text-center" }, [
                  createVNode("div", { class: "relative mb-8" }, [
                    createVNode("div", { class: "flex justify-center mb-6" }, [
                      createVNode("div", { class: "relative" }, [
                        createVNode("div", { class: "absolute inset-0 bg-primary/20 rounded-full blur-2xl animate-pulse" }),
                  ...
                  createVNode("div", { class: "space-y-4 mb-10" }, [
                    createVNode("h1", { class: "text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900" }, toDisplayString(unref(errorTitle)), 1),
                    createVNode("p", { class: "text-lg sm:text-xl text-gray-600 max-w-xl mx-auto" }, toDisplayString(unref(errorDescription)), 1)
                  ]),
                  createVNode("div", { class: "flex flex-col sm:flex-row items-center justify-center gap-4" }, [
                  ...
                  createVNode("div", { class: "mt-12 pt-8 border-t border-gray-200" }, [
                    createVNode("p", { class: "text-sm text-gray-500" }, [
                      createTextVNode(" Need assistance? "),
                  ...
                  createVNode("div", { class: "mt-8 flex justify-center gap-4 text-gray-300" }, [
                    createVNode(_component_UIcon, {
                      name: "i-heroicons-paper-airplane-20-solid",
                      class: "w-6 h-6 transform rotate-45"
                    }),
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-44b8cb6f"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { camelize as A, tryOnMounted as B, toArray as C, watchImmediate as D, pxValue as E, noop as F, useThrottleFn as G, injectLocal as H, isDef as I, useDebounceFn as J, notNullish as K, tryOnScopeDispose as L, isObject as M, get as N, usePortal as O, createSharedComposable as P, isArrayOfArray as Q, _sfc_main$a as R, pickLinkProps as S, _sfc_main$b as T, __nuxt_component_3 as U, _sfc_main$f as _, useHead as a, _sfc_main$9 as b, __nuxt_component_2$1 as c, __nuxt_component_1$1 as d, entry_default as default, _export_sfc as e, useLazyAsyncData as f, __nuxt_component_1$2 as g, useRouter as h, useAppConfig as i, useFormField as j, useFieldGroup as k, useComponentIcons as l, _sfc_main$c as m, looseToNumber as n, _sfc_main$2 as o, useToast as p, useRoute as q, useLocale as r, reactivePick as s, tv as t, useRuntimeConfig as u, useNuxtData as v, fetchDefaults as w, useAsyncData as x, useRequestFetch as y, makeDestructurable as z };
